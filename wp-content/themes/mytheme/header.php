            ...
            <div class="container d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
                ...
                <div class="container">
                    ...
                    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-controls="bs-example-navbar-collapse-1" aria-expanded="false" aria-label="<?php esc_attr_e( 'Toggle navigation', 'your-theme-slug' ); ?>">
                        ...
                        wp_nav_menu( array(
                            ...
                            'depth'             => 2,
                            'container'         => false,
                            //'container_class'   => 'd-inline-flex mt-2 mt-md-0 ms-md-auto',
                            //'container_id'      => 'bs-example-navbar-collapse-1',
                            'menu_class'        => 'navbar-nav float-right',
                ...
                <nav id="main-navigation" role="navigation">-->
                   <?php 
                    ...
                    <?php
                    /* wp_nav_menu(array(
                        'theme_location' => 'primary', // This should match the location you registered
                        'container'      => 'nav', // Wraps the menu in a <nav> element
                        //'container_class'=> 'd-inline-flex mt-2 mt-md-0 ms-md-auto', // Bootstrap classes for the navbar
                        'menu_class'     => 'd-inline-flex mt-2 mt-md-0 ms-md-auto', // Bootstrap classes for the menu
                        'walker'         => new My_Bootstrap_Walker_Nav_Menu() // Custom walker for Bootstrap compatibility
                    )); */
                    ?>
                <!-- </nav> -->
            </div>
